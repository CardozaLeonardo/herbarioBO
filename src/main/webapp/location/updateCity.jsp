...
<head>
    ...
    <title><%=Server.getAppName() %> - Nueva Ciudad</title>
...
<%
    ...
    for(Tbl_opcion op : permisions) {
        if(op.getCodename().equals("change_city")) {
            editPermission = true;
        }
    }
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="./cities">Ciudades</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="../change_city" method="POST" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                    <h5>Datos de Ciudad</h5>
                                        ...
                                        <select class="form-control" id="state" name="state" required>
                                            ...
                                            <c:if test="${states != null}">
                                                <c:forEach items="${states}" var="st">
                                                    <option value="${st.id}" ${st.id == city.state.id?"selected":""}>
                                                            ${st.name} (${st.country.name})</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                                    </div>
