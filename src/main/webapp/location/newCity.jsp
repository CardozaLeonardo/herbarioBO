...
<%
    ...
    for(Tbl_opcion op : permisions) {
        if(op.getCodename().equals("add_city")) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="../save_city" method="POST" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                        ...
                                        <select class="form-control" id="state" name="state" required>
                                            ...
                                            <c:if test="${states != null}">
                                                <c:forEach items="${states}" var="st">
                                                    <option value="${st.id}">${st.name} (${st.country.name})</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                                    </div>
