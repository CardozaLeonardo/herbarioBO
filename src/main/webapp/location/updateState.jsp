...
<head>
    ...
    <title><%=Server.getAppName() %> Editar Estado</title>
...
<%
    ...
    for(Tbl_opcion op : permisions) {
        if(op.getCodename().equals("change_state")) {
            editPermission = true;
        }
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <section class="content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Registro [Editar Estado]</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="./states">Estados</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="../changeState" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    <h5>Datos de Estado</h5>

                                    <input type="hidden" name="stateID" value="${state.id}">
                                    <div class="form-group">
                                        <label for="name">Nombre</label>
                                        <input type="text" class="form-control" id="name" placeholder="Nombre"
                                               name="name" value="${state.name}" required>
                                    </div>
                                        ...
                                        <select class="form-control" id="country" name="country" required>
                                            ...
                                            <c:if test="${countries != null}">
                                                <c:forEach items="${countries}" var="cou">
                                                    <option value="${cou.id}" ${cou.id == state.country.id?"selected":""}>${cou.name}</option>
                                                </c:forEach>
                                            </c:if>
                                        </select>
                                    </div>
