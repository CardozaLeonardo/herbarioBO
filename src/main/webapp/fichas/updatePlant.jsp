...
<title><%=Server.getAppName() %> Editar Planta</title>
...
String idUser = "";
  ...
  if(request.getAttribute("pass") == null){
	  response.sendRedirect("./updatePlant");
	  return;
  }
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              ...
	              <li class="breadcrumb-item active">Actualizar Planta</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                    ...
                    <form role="form" action="../actualizarPlant" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="idPlant" id="idPlant" value="<%=mus.getId()%>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="specimenDescription" rows="3"
                                    placeholder="Descripción del espécimen" name="description" >${mus.description}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="complete" name="complete" required>
                                  <option value="">Seleccione...</option>
                                  <option value="true" ${mus.complete?"selected":""}>Sí</option>
                                  <option value="false" ${!mus.complete?"selected":""}>No</option>
                                </select>
                            </div>
                                  ...
                                  <option value="">Seleccione...</option>
                                   <c:if test="${bios != null}">
                                     <c:forEach items="${bios}" var="bio">
                                         <option value="${bio.id}" ${mus.biostatus.id == bio.id?"selected":""}>${bio.name}</option>
                                     </c:forEach>
                                   </c:if>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="card bg-light" style="min-height: 400px; width:90%;margin-left: auto;margin-right:auto;">
                             <img id="imagePreview" src="<%=StringAdapt.adaptDriveImage(((Tbl_plantSpecimen) request.getAttribute("mus")).getPhoto_url())%>" alt="image preview" width="60%" height="auto"
