              ...
              <form role="form" action="../SLguardarUsuario" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    title="Recuerde usar teclas mayÃºsculas, minÃºsculas, nÃºmeros y caracteres especiales..." 
                  ...
                  <div class="form-group">
                    ...
                    placeholder="Ingrese una cuenta de correo electrÃ³nico vÃ¡lida, Ejemplo: ejemplo@ejemplo.com" required>
                  </div>
